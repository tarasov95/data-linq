...
namespace System.Data.Linq.SqlClient {
    ...
    internal class SqlInsert : SqlStatement {
        ...
        internal SqlInsert(
	        ...
	        bool shouldOverrideAutogeneratedIdentity = false)
	        : base(SqlNodeType.Insert, sourceExpression)
        {
	        Table = table;
	        Expression = expr;
	        Row = new SqlRow(sourceExpression);
	        ShouldOverrideAutogeneratedIdentity = shouldOverrideAutogeneratedIdentity;
        }
        ...
        internal bool ShouldOverrideAutogeneratedIdentity { get; }
